...
//         static bool IsValidMemory(string healthPointer, string hasKnifePointer, string aimState1Pointer, string aimState2Pointer, string aimStateOnBoatPointer, string earlyGamePointer, string pauseStatesPointer, string pauseStates2Pointer, string pauseStates3Pointer, string gettingOnABoatPointer, string boatPointer, string weaponTypePointer, string backupAmmoPointer, string grenadeAmmoPointer, string flashbangAmmoPointer, string startMenuAndLoadingScreenPointer, Mem mem)
//         {
//             try
//             {
...
//                 return health != 0 || hasKnife != 0 || aimState1 != 0 || aimState2 != 0 || aimStateOnBoat != 0 || earlyGame != 0 || pauseStates1 != 0 || pauseStates2 != 0 || pauseStates3 != 0 || weaponType != 0 || boat != 0 || gettingOnABoat != 0 || backupAmmo != 0 || grenadeAmmo != 0 || flashbangAmmo != 0 || startMenuAndLoadingScreen != 0;
//                 // return true;
//             }
//             catch
//             {
...
//             while (!IsValidMemory(healthPointer, hasKnifePointer, aimState1Pointer, aimState2Pointer, aimStateOnBoatPointer, earlyGamePointer, pauseStatesPointer, pauseStates2Pointer, pauseStates3Pointer, gettingOnABoatPointer, boatPointer, weaponTypePointer, backupAmmoPointer, grenadeAmmoPointer, flashbangAmmoPointer, startMenuAndLoadingScreenPointer, mem))
//             {
//                 gameProcessName = Process.GetProcessesByName("re4");
...
//                         startMenuAndLoadingScreen == 56 && pauseStates1 > 0 || pauseStates2 == 71 || pauseStates3 == 256 || earlyGame == 0 || ((weaponType == 17 || weaponType == 523) && state.RotationX > 32768 && backupAmmo == -1 && (flashbangAmmo == 0 || grenadeAmmo == 0)))
//                         {
...
//                                 // (hasKnife == 1 || weaponType == 11 || weaponType == 523) && (state.RotationX < 32768 && aimState2 >= 0 || weaponType == 11 || weaponType == 523 && buttons[4] && aimState1 == 0)
//                                 (hasKnife >= 1 && hasKnife != 5 || weaponType == 11 || weaponType == 523) && (state.RotationX < 32768 && aimState2 >= 0 || weaponType == 11 || weaponType == 523)
//                                 // && (buttons[4] && aimState2 >= 0 && aimState2 != 256 || aimState2 == 256)
...
//                                 // hasKnife >= 1 && (aimState1 == 0) || (aimState1 == 256 && buttons[4]) || (aimState1 == 256 && backupAmmo <= 0 && (grenadeAmmo > 0 || flashbangAmmo > 0)) // not aiming with a knife, or aiming with a knife
//                                 // hasKnife >= 1 && (state.RotationX < 32768) || (state.RotationX < 32768 && buttons[4]) || weaponType == 143  || weaponType == 655 || weaponType == 15 || weaponType == 527 // not aiming with a knife, or aiming with a knife
//                                     // weaponType == 143 || weaponType == 655 || weaponType == 15 || weaponType == 527 || ((state.RotationX > 32768 && aimState2 >= 0 && aimState2 != 256 || aimState2 == 256) && (weaponType == 17 || weaponType == 529) && backupAmmo <= 0 && (grenadeAmmo > 0 || flashbangAmmo > 0))
//                                     (weaponType == 143 || weaponType == 655 || weaponType == 15 || weaponType == 527) && (state.RotationX > 32768)
//                                 // aimState1 == 0 && hasKnife == 1 || aimState1 == 32 && (weaponType == 11 || weaponType == 523) || weaponType == 143 || weaponType == 655 || weaponType == 15 || weaponType == 527 || ((weaponType == 17 || weaponType == 529) && backupAmmo <= 0 && (grenadeAmmo > 0 || flashbangAmmo > 0))
//                              //  || weaponType == 5273748904 long
//                              )
//                             {
...
//                             else if (
//                             (state.RotationX > 32768 && aimState2 >= 0 && aimState2 != 256 || aimState2 == 256) && (weaponType == 1 || weaponType == 1025 || weaponType == 513) // SG-09 R - a custom handgun made for Leon
...
//                             else if (
//                             // weapon_type.Contains("handgun") ||
//                             (state.RotationX > 32768 && aimState2 >= 0 && aimState2 != 256 || aimState2 == 256) && (weaponType == 12289 || weaponType == 13313 || weaponType == 12801) // Sentinel Nine - a fully customized handgun for tackling bioterrorism
...
//                             else if (
//                                 (state.RotationX > 32768 && aimState2 >= 0 && aimState2 != 256 || aimState2 == 256) && (weaponType == 5 || weaponType == 517) // SR M193 - a bolt action rifle with a scope
...
//                             else if (
//                             (state.RotationX > 32768 && aimState2 >= 0 && aimState2 != 256 || aimState2 == 256) && (weaponType == 66 || weaponType == 578) // Skull Shaker - a shotgun with a sawed off stock and barrel
...
//                             (state.RotationX > 32768 && aimState2 >= 0 && aimState2 != 256 || aimState2 == 256) && (weaponType == 2 || weaponType == 514) // W-870 - a 12-gauge pump action shotgun
...
//                             }
//                             else if (
//                             (state.RotationX > 32768 && aimState2 >= 0 && aimState2 != 256 || aimState2 == 256) && (weaponType == 3 || weaponType == 515) // TPM - a small lightweight submachine gun
...
//                             }
//                             else if (
//                             (state.RotationX > 32768 && aimState2 >= 0 && aimState2 != 256 || aimState2 == 256) && (weaponType == 9 || weaponType == 521) // bolt thrower - a weapon that shoots bolt projectiles
...
//                                 // }
//                             }
//                             // else if (hasKnife >= 1 && aimState1 == 0 && aimState2 == 256 && backupAmmo > -1)
//                             // else if (hasKnife == 1 && aimState1 == 0 && backupAmmo > -1)
//                             // {
//                             //     // do nothing
//                             // }
//                             else
