...
//         static bool IsValidMemory(string healthPointer, string hasKnifePointer, string aimStatePointer1, string pauseStatesPointer, string weaponTypePointer, Mem mem)
//         {
//             try
//             {
...
//             string healthPointer = "re4.exe+0DAA0790,50,18,28,178,210,30,44"; // Another example for float health
...
//             while (!IsValidMemory(healthPointer, hasKnifePointer, aimState1Pointer, pauseStatesPointer, weaponTypePointer, mem))
//             {
//                 gameProcessName = Process.GetProcessesByName("re4");
...
//                         if (health == 0 || health == 32758 || pauseStates > 0) // aimState == 1 for cutscenes, pauseStates == 0 for pause and map menus
//                         {
...
//                                 hasKnife >= 1 && (state.RotationX < 32768) || (state.RotationX < 32768 && buttons[4]) || (state.RotationX > 32768 && backupAmmo <= 0 && (grenadeAmmo > 0 || flashbangAmmo > 0)) // not aiming with a knife, or aiming with a knife
...
//                             // else if (
//                             // // weapon_type.Contains("handgun") ||
//                             // aimState1 == 256 && aimState2 == 256 && (weaponType == 1 || weaponType == 513 || weaponType == 12289 || weaponType == 12801 ) // not aiming with a knife
//                             //                                                                                  // || weaponType == 4326952780 long
//                             // )
//                             // {
...
//                             //     aimState1 == 256 && aimState2 == 256 && (weaponType == 5 || weaponType == 517
...
//                             // aimState1 == 256 && aimState2 == 256 && (weaponType == 66 || weaponType == 578)
...
//                             // else if (
//                             // // weapon_type.Contains("shotgun") ||
//                             // aimState1 == 256 && aimState2 == 256 && (weaponType == 3 || weaponType == 515)
//                             //  //  || weaponType == 7146889127 long
//                             //  )
//                             // {
